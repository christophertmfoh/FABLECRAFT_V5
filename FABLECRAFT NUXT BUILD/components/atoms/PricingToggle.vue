...
const indicatorClasses = computed(() => [props.modelValue ? 'translate-x-0' : 'translate-x-full'])
...
const annualButtonClasses = computed(() => [
  ...baseButtonClasses,
  props.modelValue ? 'text-primary-foreground' : 'text-muted-foreground hover:text-foreground',
])
...
const discountClasses = computed(() => [
  ...
  props.modelValue ? 'text-primary-foreground/80' : 'text-muted-foreground/60',
])
</script>
